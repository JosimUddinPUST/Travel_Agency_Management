    ...
    <div class="main-content">
        ...
        <section class="section">
            <div class="section-header justify-content-between">
                <h1>Edit Video for {{$destination->name}}</h1>
                <div class="ml-auto">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin_destination_video_edit_submit',$destination->id) }}" method="post">
                                    @csrf
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Video ID</label>
                                            <div><input type="text" name="video_id" class="form-control" value="{{ $destination_video->video_id }}"></div>
                                        </div>
                                    </div>
