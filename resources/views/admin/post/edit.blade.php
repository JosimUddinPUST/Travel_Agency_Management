                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin_post_edit_submit',$post->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div><img src="{{ asset('uploads/'.$post->photo) }}" alt="No Photo Exist" class="w_200"></div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" class="form-control h_100" cols="30" rows="30">{{ $post->short_description }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Description</label>
                                        <textarea name="description" class="form-control editor" cols="30" rows="30">{{ $post->description }}</textarea>
                                    </div>
