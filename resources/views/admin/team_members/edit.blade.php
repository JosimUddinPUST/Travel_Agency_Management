    ...
    <div class="main-content">
        ...
        <section class="section">
            <div class="section-header justify-content-between">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin_team_member_index') }}" class="btn btn-primary"><i class="fas fa-plus">View All</i></a>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_team_member_edit_submit',$team_member->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div><img src="{{ asset('uploads/'.$team_member->photo) }}" alt="No Photo Exist" class="w_200"></div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="biography" class="form-control editor" cols="30" rows="30">{{ $team_member->biography }}</textarea>
                                    </div>
